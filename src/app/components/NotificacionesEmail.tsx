    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="mb-2">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          Agrega direcciones de correo electrónico para recibir
          notificaciones cuando aparezcan nuevas licitaciones.
        </p>
      </div>
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-4 py-3 rounded-lg text-sm border border-slate-300 bg-white text-slate-700 font-medium hover:border-slate-400 hover:bg-slate-50 transition-all shrink-0"
        >
          Agregar
        </button>
      </div>
