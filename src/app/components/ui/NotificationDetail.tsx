...
export function NotificationDetail({ detail, onBack }: NotificationDetailProps) {
  return (
      ...
      {detail.content && (
        <div className="flex flex-col gap-1.5">
          ...
          <div className="bg-slate-50 rounded-md border border-slate-200 p-3">
            <p className="text-sm text-slate-700 leading-relaxed whitespace-pre-wrap">{detail.content}</p>
          </div>
        </div>
      )}
    </div>
