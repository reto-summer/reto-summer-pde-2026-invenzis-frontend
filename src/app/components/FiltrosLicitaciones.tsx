...
export default function FiltrosLicitaciones({ onClose }: FiltrosLicitacionesProps) {
  const {
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="mt-4">
        <button
          ...
          disabled={!hasChanges}
          className={`w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg text-sm font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-1 ${
            hasChanges
